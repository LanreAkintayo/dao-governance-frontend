          ...
          <div className="flex items-center self-center text-base w-full">
            {!isBreakpoint && (
              <>
                ...
                <Link href="/token  ">
                  <a
                    className={`sm:ml-5 w-full text-white ${
                      currentUrl == "/token" && "border-b-2 border-amber-600"
                ...
                <Link href="/create">
                  <a
                    className={`sm:ml-5 ml-6 text-white font-semibold whitespace-nowrap ${
                      currentUrl == "/create" && "border-b-2 border-amber-600"
                    }  hover:text-amber-600`}
                  >
                    Create Proposal
                  </a>
                ...
                <Link href="/proposals">
                  <a
                    ...
                    }  text-white font-semibold hover:text-amber-600`}
                  >
                    Vote
                  </a>
                </Link>
