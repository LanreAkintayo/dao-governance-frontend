               ...
               if (!connected) {
                 return (
                   <button
                     ...
                     type="button"
                     className="mr-5 px-3 bg-red-800 hover:bg-red-700  rounded-full text-white py-2 "
                   >
                     Connect Wallet
                   </button>
                 );
               ...
               if (chain.unsupported || chain.id != supportedChainId) {
                 return (
                   <button
                     ...
                     type="button"
                     className="mr-5 px-3 bg-red-700 hover:bg-red-700 rounded-full text-white py-2 "
                   >
                     Switch To Sepolia
                   </button>
                 );
...
//           <div>
//             <button
//               className="rounded-full bg-red-800 hover:bg-red-700 text-white px-4 p-2 mr-3 text-sm ssm:text-base"
//               onClick={async () => {
//                 try {
//                   await switchNetwork({
